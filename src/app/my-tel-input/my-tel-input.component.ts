...
export class MyTelInputComponent
    implements ControlValueAccessor, MatFormFieldControl<MyTel | string>, OnDestroy {
  static nextId = 0;
  ...
  set value(tel: MyTel | null | string) {
      if (typeof tel === 'string') {
          // TODO: check here
          const area = tel.substr(0, 3);
          const exchange = tel.substr(3, 3);
          const subscriber = tel.substr(6, 4);
